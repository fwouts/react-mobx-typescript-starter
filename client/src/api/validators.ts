...
export function validate_SayHelloRequest(
  value: any,
): value is types.SayHelloRequest {
...
export function validate_SayHelloResponse(
  value: any,
): value is types.SayHelloResponse {
  if (typeof value !== "object" || value === null) {
    return false;
  }
...
export function validate_SayHello_Response(
  value: any,
): value is types.SayHello_Response {
